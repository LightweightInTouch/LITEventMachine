...
- (void)setupEventMachine {
    [LITEMEventMachine eventMachine].eventBus.eventFactory = [LITCustomEventFactory new];
}

- (void)setupEventHandling {
    [[LITEMEventMachine eventMachine].eventBus subscribeDelegate:self withName:@"AppDelegateForExample" onEvent:[[LITEMEventSayHello alloc] christmasIsComing]];
}

- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    // Override point for customization after application launch.
    [self setupEventMachine];
